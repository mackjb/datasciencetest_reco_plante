...
def sidebar_choice():
    ...
    with tab1:
        ...
        st.image("Streamlit/assets/dataset_overview.png", caption="Un aperçu de la diversité des espèces et pathologies dans le dataset PlantVillage", width="stretch")
        ...
        """)
        st.image("Streamlit/assets/dataset_comparison.png", caption="Comparaison des caractéristiques entre PlantVillage et ses variantes", width="stretch")
    ...
    with tab3:
        ...
        if os.path.exists(csv_full_path):
            ...
            *   Ce déséquilibre est un défi majeur : le modèle pourrait avoir tendance à prédire plus facilement les classes sur-représentées.
            ...
            st.image("Streamlit/assets/class_distribution_analysis.png", caption="Répartition détaillée (version statique)", width="stretch")
