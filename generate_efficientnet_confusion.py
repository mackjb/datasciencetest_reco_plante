...
# -*- coding: utf-8 -*-
"""
Génère la matrice de confusion (heatmap) pour la cascade EfficientNetV2 sur les classes finales.
"""
import json
import os
import sys
...
from train_cascade_efficientnet import (
...
def main():
    ...
    output_dir = 'outputs/cascade_efficientnet'
